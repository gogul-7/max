...
const Wash2 = () => {
  ...
  }, [personalDetails, vehicleDetails, addressDetails]);
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              ₹ <Text style={[styles.header]}>116</Text>
            </Text>
          </View>
        </View>
        <Text
        ...
        {Object.keys(vehicleDetails).length !== 0 ? (
          ...
          >
            ...
            <TouchableOpacity
              onPress={() => navigation.navigate("wash9")}
              style={styles.button3}
            >
              <Text
                style={[
