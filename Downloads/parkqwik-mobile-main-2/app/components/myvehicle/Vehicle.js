...
export default function Vehicle() {
  const { setVehicleDetails, vehicleDetails, clientId } =
    ...
    const retrieveData = async () => {
      try {
        ...
        if (storedData !== null) {
          ...
          const filterData = parsedDataArray.find(
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={[styles.vehicletype]}>Fuel Type</Text>
        <TouchableOpacity
        ...
        >
          <View style={styles.modal}>
            ...
            <RadioButton.Group
              onValueChange={(value) => {
                setDetails({ ...details, fuel: value }), setModal(false);
              }}
              value={details.fuel}
            >
              <View style={{ gap: 5 }}>
