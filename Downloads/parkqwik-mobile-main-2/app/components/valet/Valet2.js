      ...
      >
        ...
        >
          ...
          >
            ...
            >
              ₹ <Text style={[styles.header]}>70</Text>
            </Text>
          </View>
        </View>
        <Text
        ...
        {Object.keys(personalDetails).length !== 0 ? (
          ...
          >
            ...
            <TouchableOpacity
              onPress={() => navigation.navigate("valet5")}
              style={styles.button}
            >
              <Image
        ...
        {Object.keys(vehicleDetails).length !== 0 ? (
          ...
          >
            ...
            >
              {vehicleDetails.type} | {vehicleDetails.fuel}
            </Text>

            <TouchableOpacity
              onPress={() => navigation.navigate("valet6")}
              style={styles.button}
            >
              <Image
                source={require("../assets/images/greenedit.png")}
