...
const Nearby1 = () => {
  ...
  const data2 = useSelector((state) => state.placeData);
  const mapRef = useRef();
  ...
  return (
    <TouchableWithoutFeedback onPress={() => setSearchSection(false)}>
      <View style={{ flex: 1 }}>
          ...
          >
            ...
            >
              ...
              >
                <Image
                  style={{ height: 24, width: 24 }}
                  source={require("../assets/images/greencharge.png")}
                />
                <Text style={[styles.text, { color: "#1B9E76", fontSize: 10 }]}>
                  Charge
                </Text>
            ...
            >
              ...
              <TouchableOpacity
                onPress={() => navigation.navigate("nearby9")}
                style={{ alignItems: "center" }}
              >
                <Image
                  style={{ height: 24, width: 24 }}
        ...
        >
          <Nearby7 setModal6={setModal6} setCheckout={setCheckout} />
        </Modal>
        <Modal
          isVisible={checkout}
          backdropOpacity={0.4}
